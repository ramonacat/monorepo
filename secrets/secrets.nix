let
  ...
  ananas = "ssh-rsa  root@nixos";
  ...
  redwood = "ssh-rsa ";
  allMachines = [redwood hallewell ananas shadowsoul angelsin evillian caligari];
in {
  ...
  "minio-terraform-state.age".publicKeys = users ++ [angelsin];
  "terraform-tokens.age".publicKeys = users ++ [angelsin];
