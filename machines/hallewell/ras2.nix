{
  ...
  systemd.services.phpfpm-ras2 = {
    preStart = "mkdir -p /tmp/migrations; cd /tmp/migrations/; cp ${config.age.secrets.ras2-db-config.path} db-migrations.php; ${pkgs.ramona.ras2}/share/php/ras2/vendor/bin/doctrine-migrations migrate; rm -r /tmp/migrations";
  };
}
